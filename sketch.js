...
function preload(){
  ...
  // backgroundImage = loadImage("ng.png");  
}
...
background("white");
 ...
 fill("black")
 blocks9.display();
text("drag the line and relase to hit the boxes",600,250)


 ellipse(ball.position.x,position.y,20);
 Slingshot.display();
}

function mouseDragged(){
    Matter.Body.stePosition(this.ball,{x:mouseX,y:mouseY})   
}
